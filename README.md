...
Direct queries to external public DNS resolvers initially timed out before resolving successfully. Connectivity to those resolver IP addresses was confirmed with ICMP ping.
